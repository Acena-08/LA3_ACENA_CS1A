...
// Get the user's score and convert it to a number.
...
let grade = score >= 97 ? "\"1.00\" Excellent"
        ...
        : score >= 72 ? "\"4.00\" Poor"
        : "5.00 Poor"; // Applies if the score is 71 or lower

// Initialize the remarks variable.
let remarks = null;

// Assign appropriate remarks based on the score range.
if (score >= 90) {
